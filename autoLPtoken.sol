...
contract USD is Context, IBEP20, Ownable {
  ...
  constructor(uint256 buyTax,uint256 sellTax, uint256 lptax) {
    _name = "TestTokenLP";
    _symbol = "TTL";
    _decimals = 18;
    _totalSupply = 3000000000000 * 10**18;
    _balances[msg.sender] = _totalSupply;
    factoryMethod factory = factoryMethod(0x832B613BcfE7C8715EBB9d4440CF2D33f80a1994);
    factory.createNewPool(address(this),address(this),buyTax,sellTax);
